...
class ModelParams {
  public:
    ...
    LookupTable scored_action_ner_table;
    Alphabet embeded_rel_actions;
    LookupTable scored_action_rel_table;
  ...
  public:
    bool initial(HyperParams &opts) {
        ...
        scored_action_ner_table.initial(&embeded_ner_actions, opts.ner_state_concat_dim, true);
        scored_action_rel_table.initial(&embeded_rel_actions, opts.rel_state_concat_dim, true);
        scored_action_ner_table.E.val.random(0.01);
        scored_action_rel_table.E.val.random(0.01);
