        ...
        if (allow_ner()) {
            ...
            if (modvalue == 0 || modvalue == 3) { //o, e-xx, s-xx
                ...
                for (int i = 0; i < opts->ner_noprefix_num; i++) {
                    ...
                    if (!lastPosition && params->embeded_ner_actions.from_string(ac.str(opts)) >= 0)actions.push_back(ac);
        ...
        if (allow_rel()) {
            ...
            if (label_i > 0 && label_j > 0
                ...
                if (next_head_index == _head_size - 1 && _headed_entities[next_entity_index] == 0) {
                    ...
                    } else if (ji_rel_labelid > 0) {
                        ac.set(CAction::REL, -ji_rel_labelid);
                    } else {
                        std::cout << "impossible to find oracle action" << std::endl;
                    }
                } else {
